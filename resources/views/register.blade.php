            ...
            <div class="container">
                <div class="header-top">
                    ...
                    <div class="login-bars">
                        <a class="btn btn-default log-bar" href="register.blade.php" role="button">Sign up</a>
                        <a class="btn btn-default log-bar" href="signup.blade.php" role="button">Login</a>
                            ...
                            <ul class="nav navbar-nav nav-font">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="divider"></li>
                                        <li><a href="products.blade.php">Tracks</a></li>
                                        <li class="divider"></li>
        ...
        <div class="head-bread">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li><a href="register.blade.php">LOGIN</a></li>
